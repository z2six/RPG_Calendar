...
public final class RPGTimelineItems {
    ...
    public static final RegistryObject<Item> CHRONICLE_NOTE = ITEMS.register(
            "chronicle_note",
    ...
    public static final RegistryObject<Item> CHRONICLE_WORLD_FIRST = ITEMS.register(
    ...
    public static final RegistryObject<Item> CHRONICLE_ADVANCEMENT = ITEMS.register(
