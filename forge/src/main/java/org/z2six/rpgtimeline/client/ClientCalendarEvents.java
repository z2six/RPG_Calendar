...
public final class ClientCalendarEvents {
    ...
    private static final ResourceLocation GOTHIC24_FONT_ID =
            new ResourceLocation(Constants.MOD_ID, "gothic24");

    private static final ResourceLocation TOP_ORNAMENT =
            new ResourceLocation(Constants.MOD_ID, "textures/gui/top_ornament_dropshadow.png");
    private static final ResourceLocation BOTTOM_ORNAMENT =
            new ResourceLocation(Constants.MOD_ID, "textures/gui/bottom_ornament_dropshadow.png");
