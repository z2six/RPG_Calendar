...
public final class RPGTimelineCalendarSavedData extends SavedData {
    ...
    public static RPGTimelineCalendarSavedData get(MinecraftServer server) {
        return server.overworld()
                .getDataStorage()
                .computeIfAbsent(RPGTimelineCalendarSavedData::load, RPGTimelineCalendarSavedData::new, DATA_NAME);
    }
    ...
    private static RPGTimelineCalendarSavedData load(CompoundTag tag) {
