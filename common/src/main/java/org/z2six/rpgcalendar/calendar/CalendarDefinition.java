 ...
 * The NeoForge config (RPGCalendarConfig) creates instances of this class on the server.
 *
 * NOTE:
...
public final class CalendarDefinition {
     ...
     * supplied by the platform config (RPGCalendarConfig).
     */
    ...
    /**
     * Public constructor used by platform-specific code (e.g. RPGCalendarConfig on NeoForge).
     *
